...
# Figures Folder
fig_subdir <- file.path(figs_dir, "0.2.1 ISS surface_core_annotation")
...
ggsave(
  filename = file.path(fig_subdir, "p1_dist_of_counts_of_cells_with_n_neighbours_in_radius.tiff"),
  plot = p1,
  width = 7.87, 
  height = 6,
  dpi = 300,
...
p2 <- plot_surface_classification(
  data = iss_meta,
...
ggsave(
  filename = file.path(fig_subdir, "p2_ME_annotations_radius_method.tiff"),
  plot = p2,
  width = 7.87, 
  height = 6,
  dpi = 300,
