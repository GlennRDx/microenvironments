...
# Parameters
# Choose classification type (nearest neighbours or clustering method - check script 0.2.1)
...
# 
# # filter out cells
# iss_obj_invasive <- subset(iss_obj_invasive, subset = depth_category != "Shallow Core" & !is.na(surface_class_clusters))
# 
