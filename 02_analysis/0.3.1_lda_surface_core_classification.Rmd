...
# 2. Assign 2/3 of the shared genes (between ISS/scRNA) as training training genes
```{r}
...
# 4. Normalise the matrix with log transformation
```{r}
...
# 5. Extract normalised counts, add surface_class column
```{r}
