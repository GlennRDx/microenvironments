...
# Filter genes to include only the training genes
```{r}
...
# Default to "Correct" (this covers background cells and correct predictions)
plot_meta$classification_status <- "Correct"

# Identify Test Set cells
test_cells <- rownames(inv_gene_exp_test)

# Assign status for Test Set cells
# Logic: If truth == prediction, keep "Correct", otherwise label the error
