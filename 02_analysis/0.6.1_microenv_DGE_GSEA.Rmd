...
```{r}
library(tidyverse)
library(ggtext) # Required for rendering bold/colored text in plot labels
library(scales)

# ==============================================================================
# 1. Clustering Function (The Redundancy Reducer)
# ==============================================================================
...
gsea_full_filt <- gsea_full[gsea_full$qvalue < 0.005,]

# 1. Run Clustering
# h = 0.9 is strict (must be very similar). Lower h (e.g., 0.5) to group more aggressively.
clustered_df <- cluster_go_terms(gsea_full_filt, h = 0.9)
