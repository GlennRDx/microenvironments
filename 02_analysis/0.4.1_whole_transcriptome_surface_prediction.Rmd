...
# Pass the predicted labels back to the original wts obj
wts_obj <- readRDS("janesick_2023/processed/wts_obj_processed.RDS")
wts_obj <- AddMetaData(wts_obj, metadata = meta_to_add) # add metadata
saveRDS(wts_obj, file = "janesick_2023/processed/wts_obj_processed_predicted.RDS")
```