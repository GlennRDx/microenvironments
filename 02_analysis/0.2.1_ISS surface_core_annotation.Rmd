...
ggsave(file.path(fig_subdir, "p1_dist_of_counts_of_cells_with_n_neighbours_in_radius.png"), 
       plot = p1, dpi = 300, width = 7.87*1.75, height = 6.5*1.75)
```
...
ggsave(file.path(fig_subdir, "p2_ME_annotations_radius_method.png"), 
       plot = p2, dpi = 300, width = 7.87*1.75, height = 6.5*1.75)
```
...
ggsave(file.path(fig_subdir, "p3_ME_annotations_knn_method.png"), 
       plot = p3, dpi = 300, width = 7.87*1.75, height = 6.5*1.75)
```
...
ggsave(file.path(fig_subdir, "p4_ME_annotations_depth_method.png"), 
       plot = p4, dpi = 300, width = 7.87*1.75, height = 6.5*1.75)
```
...
p5 <- plot_surface_classification(
  ...
  title = "Highlighting Shallow Core Cells (Depth ≤ 5)"
)
...
ggsave(file.path(fig_subdir, "p5_identify_shallow_core_cells.png"), 
       plot = p5, dpi = 300, width = 7.87*1.75, height = 6.5*1.75)
```
...
ggsave(file.path(fig_subdir, "p6_leiden_cluster_tumour_cells.png"), 
       plot = p6, dpi = 300, width = 7.87*1, height = 6.5*1)
```
