...
ggplot(iss_meta, aes(x = y_centroid, y = x_centroid, color = surface_class_radius)) +
...
```
```{r, fig.width=7.87*1.75, fig.height = 6.5*1.75, dpi=300, dev='tiff', out.width='100%'}
ggplot(iss_meta, aes(x = y_centroid, y = x_centroid)) +
...
```{r, fig.width=7.87*1.75, fig.height = 6.5*1.75, dpi=300, dev='tiff', out.width='100%'}
ggplot(iss_meta, aes(x = y_centroid, y = x_centroid, color = surface_class_clusters)) +
    # Layer 1: Plot only "Other" first
